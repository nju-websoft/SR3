...
class ReportMgrBase(object):
    ...
    def __init__(self, report_every, start_time=-1.,ext_copy=None):
        """
        Args:
...
class Statistics(object):
    ...
    * elapsed time
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        logger.info(
            ("Step %2d/%5d; acc: %6.2f; ppl: %5.2f; xent: %4.2f; " +
             "%3.0f/%3.0f tok/s; %6.0f sec ; lr:%7.8f;")
            % (step, num_steps,
               self.accuracy(),
               self.ppl(),
               self.xent(),
    ...
    def log_tensorboard(self, prefix, writer, learning_rate, step):
        ...
        writer.add_scalar(prefix + "/lr", learning_rate[0].learning_rate, step)
